...
[Install](#install) · [Features](#features) · [Film](#film) · [Manual](corridor-newtab/README.md) · [Privacy](PRIVACY.md) · [Changelog](CHANGELOG.md)
...
<sub>Ninety seconds in the Corridor</sub>
